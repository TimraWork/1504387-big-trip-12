...
render(events, createFormTemplate(), `beforeend`);
render(events, createDaysListTemplate(), `beforeend`);

const daysList = events.querySelector(`.trip-days`);

render(daysList, createDayTemplate(), `beforeend`);

const day = events.querySelector(`.trip-days__item.day`);
